...
Um daraus eine Schleife zu machen setzt kann man einen Counter einsetzen. Am Anfang des Programmes _count = 0_ setzen und dann _while (count < x):_ das sieht dann so aus:  
count = 0  
while (count < x):  
